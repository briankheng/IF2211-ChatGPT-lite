    ...
    return (
        <div className="relative">
            ...
            >
                ...
                <div className="ml-3">
                <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 flex-shrink-0 text-gray-400" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            {isDropdownOpen && (
                <div className="dp">
                    ...
                    style={{ bottom: "100%" }}
                >
                    <div className="py-2 px-4 text-sm cursor-default hover:bg-gray-700 dropdown" onClick={handleSignOut}>
                        Sign Out
                    </div>
                    <div className="flex items-center mx-auto border-b-2 border-white/5"></div>

                    <div className="py-2 px-4 text-sm cursor-default hover:bg-gray-700 dropdown" onClick={() => signIn("google")}>
                        Change Account
                    </div>
